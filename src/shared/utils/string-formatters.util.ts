 ...
 */
export const formatNumber = (num: number | string, decimals: number = 0, decimalSeparator: string = '.', thousandSeparator: string = ','): string => {
...
export const toUpperCamelCase = (str: string | null | undefined): string | undefined => {
