...
declare global {
    namespace Express {
        ...
        interface Response {
             ...
             */
            sendSuccess?: <T = any>(data: T, message?: string, statusCode?: number, metadata?: PaginationMetadata) => void;
        }
 ...
 */
export type ControllerHandler = (req: Express.Request, res: Express.Response, next: Express.NextFunction) => Promise<any> | any;

/**
 * Tipo para funciones de middleware
 */
export type MiddlewareHandler = (req: Express.Request, res: Express.Response, next: Express.NextFunction) => void | Promise<void>;
